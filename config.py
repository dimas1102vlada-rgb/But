...
# Сообщения
text_messages = {
    'start': 'Здравствуйте {}, для вступления в клан необходимо заполнить небольшую анкету
Анкета для вступления:

Имя
Возраст
Часовой пояс относительно мск
Был/а ли в других кланах, что стало причиной ухода 
Скрин статистики в пабге за два последних сезона ',
