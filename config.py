...
support_chat = '-1003779793727' # Пример: -1001429781350 | Узнать ID своего канала можно тут: https://t.me/getidsbot

admin_ids = [7121765268,5699458408,329147047,547722486,814652572,6531375203]
...
text_messages = {
      'start': '''\
Здравствуйте {}, для вступления в клан необходимо заполнить небольшую анкету
...
Скрин статистики в пабге за два последних сезона''',
      ...
      'support_response': 'Отправлено от заместителя клана: {}'    # Ответ службы поддержки добавляется автоматически. {} = заменяется именем сотрудника.
}
